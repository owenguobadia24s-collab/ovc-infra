# Path 1 State Plane Run: p1_20260204_001

## Run Metadata

| Field | Value |
|-------|-------|
| `run_id` | `p1_20260204_001` |
| `date_ny` | `2023-10-02` |
| `symbol` | `GBPUSD` |
| `generated_at` | `2026-02-04T22:45:58Z` |
| `block_count` | `12` |
...
```bash
python scripts/path1/run_state_plane.py --symbol GBPUSD --date 2023-10-02
```
...
```
Run executed: 2026-02-04T22:45:58Z
Output location: C:\Users\Owner\projects\ovc-infra\reports\path1\evidence\runs\p1_20260204_001
```
