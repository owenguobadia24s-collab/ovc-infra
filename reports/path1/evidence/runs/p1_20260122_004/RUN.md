# Path 1 State Plane Run: p1_20260122_004

## Run Metadata

| Field | Value |
|-------|-------|
| `run_id` | `p1_20260122_004` |
| `date_ny` | `2022-09-26` |
| `symbol` | `GBPUSD` |
| `generated_at` | `2026-01-22T18:43:24Z` |
| `block_count` | `12` |
...
```
Run executed: 2026-01-22T18:43:24Z
Output location: C:\Users\Owner\projects\ovc-infra\reports\path1\evidence\runs\p1_20260122_004
```
