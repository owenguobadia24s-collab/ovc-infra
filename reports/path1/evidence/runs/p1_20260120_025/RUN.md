# Path 1 Evidence Run: p1_20260120_025

## Run Metadata

| Field | Value |
|-------|-------|
| `run_id` | `p1_20260120_025` |
| `date_range_requested` | `2023-07-10` to `2023-07-14` |
| `date_range_actual` | `2023-07-10` to `2023-07-14` |
| `symbol(s)` | `GBPUSD` |
| `generated_at` | `2026-01-22T06:26:49Z` |
| `n_observations` | `59` |
...
psql $DATABASE_URL -c "SELECT COUNT(*) AS rows_in_range FROM derived.v_path1_evidence_dis_v1_1 WHERE sym = 'GBPUSD' AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-07-10' AND '2023-07-14';"

# Execute DIS-v1.1 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_025/study_dis_v1_1.sql" | tee "reports/path1/evidence/runs/p1_20260120_025/outputs/study_dis_v1_1.txt"

# Execute RES-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_025/study_res_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_025/outputs/study_res_v1_0.txt"

# Execute LID-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_025/study_lid_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_025/outputs/study_lid_v1_0.txt"
```
...
SQL sources: sql/path1/evidence/runs/p1_20260120_025/
Output location: reports/path1/evidence/runs/p1_20260120_025/outputs/
