# Path 1 Evidence Run: p1_20260120_024

## Run Metadata

| Field | Value |
|-------|-------|
| `run_id` | `p1_20260120_024` |
| `date_range_requested` | `2023-07-17` to `2023-07-21` |
| `date_range_actual` | `2023-07-17` to `2023-07-21` |
| `symbol(s)` | `GBPUSD` |
| `generated_at` | `2026-01-22T06:25:43Z` |
| `n_observations` | `59` |
...
psql $DATABASE_URL -c "SELECT COUNT(*) AS rows_in_range FROM derived.v_path1_evidence_dis_v1_1 WHERE sym = 'GBPUSD' AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-07-17' AND '2023-07-21';"

# Execute DIS-v1.1 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_024/study_dis_v1_1.sql" | tee "reports/path1/evidence/runs/p1_20260120_024/outputs/study_dis_v1_1.txt"

# Execute RES-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_024/study_res_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_024/outputs/study_res_v1_0.txt"

# Execute LID-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_024/study_lid_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_024/outputs/study_lid_v1_0.txt"
```
...
SQL sources: sql/path1/evidence/runs/p1_20260120_024/
Output location: reports/path1/evidence/runs/p1_20260120_024/outputs/
