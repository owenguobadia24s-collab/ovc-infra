# Path 1 Evidence Run: p1_20260120_031
...
| `date_range_requested` | `2022-12-12` to `2022-12-14` |
| `date_range_actual` | `2022-12-12` to `2022-12-14` |
| `symbol(s)` | `GBPUSD` |
| `generated_at` | `2026-01-22T01:18:44Z` |
| `n_observations` | `36` |
...
psql $DATABASE_URL -c "SELECT COUNT(*) AS rows_in_range FROM derived.v_path1_evidence_dis_v1_1 WHERE sym = 'GBPUSD' AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2022-12-12' AND '2022-12-14';"

# Execute DIS-v1.1 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_031/study_dis_v1_1.sql" | tee "reports/path1/evidence/runs/p1_20260120_031/outputs/study_dis_v1_1.txt"

# Execute RES-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_031/study_res_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_031/outputs/study_res_v1_0.txt"

# Execute LID-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_031/study_lid_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_031/outputs/study_lid_v1_0.txt"
```
...
SQL sources: sql/path1/evidence/runs/p1_20260120_031/
Output location: reports/path1/evidence/runs/p1_20260120_031/outputs/
