# Path 1 Evidence Run: p1_20260120_027

## Run Metadata

| Field | Value |
|-------|-------|
| `run_id` | `p1_20260120_027` |
| `date_range_requested` | `2023-06-26` to `2023-06-30` |
| `date_range_actual` | `2023-06-26` to `2023-06-30` |
| `symbol(s)` | `GBPUSD` |
| `generated_at` | `2026-01-22T06:29:14Z` |
| `n_observations` | `59` |
...
psql $DATABASE_URL -c "SELECT COUNT(*) AS rows_in_range FROM derived.v_path1_evidence_dis_v1_1 WHERE sym = 'GBPUSD' AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-06-26' AND '2023-06-30';"

# Execute DIS-v1.1 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_027/study_dis_v1_1.sql" | tee "reports/path1/evidence/runs/p1_20260120_027/outputs/study_dis_v1_1.txt"

# Execute RES-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_027/study_res_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_027/outputs/study_res_v1_0.txt"

# Execute LID-v1.0 study
psql $DATABASE_URL -f "sql/path1/evidence/runs/p1_20260120_027/study_lid_v1_0.sql" | tee "reports/path1/evidence/runs/p1_20260120_027/outputs/study_lid_v1_0.txt"
```
...
SQL sources: sql/path1/evidence/runs/p1_20260120_027/
Output location: reports/path1/evidence/runs/p1_20260120_027/outputs/
