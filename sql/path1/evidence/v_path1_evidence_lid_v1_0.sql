-- =============================================================================
-- View: v_path1_evidence_lid_v1_0
-- Purpose: JOIN frozen LID-v1.0 score with Option C outcomes for evidence runs
...
CREATE OR REPLACE VIEW derived.v_path1_evidence_lid_v1_0 AS
SELECT
    -- Identifiers
    s.block_id,
    s.sym,
    ...
    -- Score raw value (LID-v1.0, frozen)
