...
-- Run ID: p1_20260627_GBPUSD_20260626_len5d_d3166069 | Symbol: GBPUSD | Dates: 2026-06-22 to 2026-06-26
-- =============================================================================
...
SELECT
    ...
    'p1_20260627_GBPUSD_20260626_len5d_d3166069' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-22' AND '2026-06-26';
