...
-- Run ID: p1_20260301_GBPUSD_20260228_len5d_8da2cabf | Symbol: GBPUSD | Dates: 2026-02-24 to 2026-02-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260301_GBPUSD_20260228_len5d_8da2cabf' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-24' AND '2026-02-28';
