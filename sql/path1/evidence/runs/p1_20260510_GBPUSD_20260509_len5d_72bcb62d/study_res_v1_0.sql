...
-- Run ID: p1_20260510_GBPUSD_20260509_len5d_72bcb62d | Symbol: GBPUSD | Dates: 2026-05-05 to 2026-05-09
-- =============================================================================
...
SELECT
    ...
    'p1_20260510_GBPUSD_20260509_len5d_72bcb62d' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-05' AND '2026-05-09';
