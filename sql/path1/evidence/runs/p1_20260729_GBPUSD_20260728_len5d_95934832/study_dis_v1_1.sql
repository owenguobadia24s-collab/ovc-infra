...
-- Run ID: p1_20260729_GBPUSD_20260728_len5d_95934832 | Symbol: GBPUSD | Dates: 2026-07-24 to 2026-07-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260729_GBPUSD_20260728_len5d_95934832' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-24' AND '2026-07-28';
