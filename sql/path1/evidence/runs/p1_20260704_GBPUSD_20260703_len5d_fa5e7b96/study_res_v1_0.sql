...
-- Run ID: p1_20260704_GBPUSD_20260703_len5d_fa5e7b96 | Symbol: GBPUSD | Dates: 2026-06-29 to 2026-07-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260704_GBPUSD_20260703_len5d_fa5e7b96' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-29' AND '2026-07-03';
