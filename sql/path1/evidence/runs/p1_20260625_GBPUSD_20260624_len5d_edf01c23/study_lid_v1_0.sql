...
-- Run ID: p1_20260625_GBPUSD_20260624_len5d_edf01c23 | Symbol: GBPUSD | Dates: 2026-06-20 to 2026-06-24
-- =============================================================================
...
SELECT
    ...
    'p1_20260625_GBPUSD_20260624_len5d_edf01c23' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-20' AND '2026-06-24';
