...
-- Run ID: p1_20260304_GBPUSD_20260303_len5d_f61dfab5 | Symbol: GBPUSD | Dates: 2026-02-27 to 2026-03-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260304_GBPUSD_20260303_len5d_f61dfab5' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-27' AND '2026-03-03';
