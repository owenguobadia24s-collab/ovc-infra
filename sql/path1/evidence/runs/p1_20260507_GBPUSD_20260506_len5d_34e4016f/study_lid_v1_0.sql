...
-- Run ID: p1_20260507_GBPUSD_20260506_len5d_34e4016f | Symbol: GBPUSD | Dates: 2026-05-02 to 2026-05-06
-- =============================================================================
...
SELECT
    ...
    'p1_20260507_GBPUSD_20260506_len5d_34e4016f' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-02' AND '2026-05-06';
