...
-- Run ID: p1_20260313_GBPUSD_20260312_len5d_a65464de | Symbol: GBPUSD | Dates: 2026-03-08 to 2026-03-12
-- =============================================================================
...
SELECT
    ...
    'p1_20260313_GBPUSD_20260312_len5d_a65464de' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-08' AND '2026-03-12';
