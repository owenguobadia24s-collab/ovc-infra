...
-- Run ID: p1_20260228_GBPUSD_20260227_len5d_527c6986 | Symbol: GBPUSD | Dates: 2026-02-23 to 2026-02-27
-- =============================================================================
...
SELECT
    ...
    'p1_20260228_GBPUSD_20260227_len5d_527c6986' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-23' AND '2026-02-27';
