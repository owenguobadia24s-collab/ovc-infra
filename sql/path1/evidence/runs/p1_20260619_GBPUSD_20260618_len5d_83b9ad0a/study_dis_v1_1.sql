...
-- Run ID: p1_20260619_GBPUSD_20260618_len5d_83b9ad0a | Symbol: GBPUSD | Dates: 2026-06-14 to 2026-06-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260619_GBPUSD_20260618_len5d_83b9ad0a' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-14' AND '2026-06-18';
