...
-- Run ID: p1_20260120_012 | Symbol: GBPUSD | Dates: 2023-10-09 to 2023-10-13
-- =============================================================================
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-10-09' AND '2023-10-13';
