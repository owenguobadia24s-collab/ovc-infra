...
-- Run ID: p1_20260702_GBPUSD_20260701_len5d_1491d139 | Symbol: GBPUSD | Dates: 2026-06-27 to 2026-07-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260702_GBPUSD_20260701_len5d_1491d139' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-27' AND '2026-07-01';
