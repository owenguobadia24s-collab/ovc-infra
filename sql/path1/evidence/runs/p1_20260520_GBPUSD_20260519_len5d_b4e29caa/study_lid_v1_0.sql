...
-- Run ID: p1_20260520_GBPUSD_20260519_len5d_b4e29caa | Symbol: GBPUSD | Dates: 2026-05-15 to 2026-05-19
-- =============================================================================
...
SELECT
    ...
    'p1_20260520_GBPUSD_20260519_len5d_b4e29caa' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-15' AND '2026-05-19';
