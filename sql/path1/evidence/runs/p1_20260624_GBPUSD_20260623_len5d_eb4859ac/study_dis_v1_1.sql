...
-- Run ID: p1_20260624_GBPUSD_20260623_len5d_eb4859ac | Symbol: GBPUSD | Dates: 2026-06-19 to 2026-06-23
-- =============================================================================
...
SELECT
    ...
    'p1_20260624_GBPUSD_20260623_len5d_eb4859ac' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-19' AND '2026-06-23';
