...
-- Run ID: p1_20260302_GBPUSD_20260301_len5d_54d4804e | Symbol: GBPUSD | Dates: 2026-02-25 to 2026-03-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260302_GBPUSD_20260301_len5d_54d4804e' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-25' AND '2026-03-01';
