...
-- Run ID: p1_20260215_GBPUSD_20260214_len5d_28d5fa31 | Symbol: GBPUSD | Dates: 2026-02-10 to 2026-02-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260215_GBPUSD_20260214_len5d_28d5fa31' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-10' AND '2026-02-14';
