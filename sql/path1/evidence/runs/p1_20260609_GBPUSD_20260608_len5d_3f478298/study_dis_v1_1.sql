...
-- Run ID: p1_20260609_GBPUSD_20260608_len5d_3f478298 | Symbol: GBPUSD | Dates: 2026-06-04 to 2026-06-08
-- =============================================================================
...
SELECT
    ...
    'p1_20260609_GBPUSD_20260608_len5d_3f478298' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-04' AND '2026-06-08';
