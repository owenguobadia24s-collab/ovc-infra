...
-- Run ID: p1_20260210_GBPUSD_20260209_len5d_c56a01f7 | Symbol: GBPUSD | Dates: 2026-02-05 to 2026-02-09
-- =============================================================================
...
SELECT
    ...
    'p1_20260210_GBPUSD_20260209_len5d_c56a01f7' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-05' AND '2026-02-09';
