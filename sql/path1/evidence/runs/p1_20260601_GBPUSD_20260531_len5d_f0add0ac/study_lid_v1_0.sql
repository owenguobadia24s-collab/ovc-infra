...
-- Run ID: p1_20260601_GBPUSD_20260531_len5d_f0add0ac | Symbol: GBPUSD | Dates: 2026-05-27 to 2026-05-31
-- =============================================================================
...
SELECT
    ...
    'p1_20260601_GBPUSD_20260531_len5d_f0add0ac' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-27' AND '2026-05-31';
