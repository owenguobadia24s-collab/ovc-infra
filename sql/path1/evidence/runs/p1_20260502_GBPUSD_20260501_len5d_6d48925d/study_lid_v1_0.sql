...
-- Run ID: p1_20260502_GBPUSD_20260501_len5d_6d48925d | Symbol: GBPUSD | Dates: 2026-04-27 to 2026-05-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260502_GBPUSD_20260501_len5d_6d48925d' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-27' AND '2026-05-01';
