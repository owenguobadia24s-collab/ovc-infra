...
-- Run ID: p1_20260706_GBPUSD_20260705_len5d_ed0ea591 | Symbol: GBPUSD | Dates: 2026-07-01 to 2026-07-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260706_GBPUSD_20260705_len5d_ed0ea591' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-01' AND '2026-07-05';
