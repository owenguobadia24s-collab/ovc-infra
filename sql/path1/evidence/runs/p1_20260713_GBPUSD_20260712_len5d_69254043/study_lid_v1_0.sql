...
-- Run ID: p1_20260713_GBPUSD_20260712_len5d_69254043 | Symbol: GBPUSD | Dates: 2026-07-08 to 2026-07-12
-- =============================================================================
...
SELECT
    ...
    'p1_20260713_GBPUSD_20260712_len5d_69254043' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-08' AND '2026-07-12';
