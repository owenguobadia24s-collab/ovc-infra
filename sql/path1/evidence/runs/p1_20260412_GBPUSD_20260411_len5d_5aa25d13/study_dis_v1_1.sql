...
-- Run ID: p1_20260412_GBPUSD_20260411_len5d_5aa25d13 | Symbol: GBPUSD | Dates: 2026-04-07 to 2026-04-11
-- =============================================================================
...
SELECT
    ...
    'p1_20260412_GBPUSD_20260411_len5d_5aa25d13' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-07' AND '2026-04-11';
