...
-- Run ID: p1_20260708_GBPUSD_20260707_len5d_f48c1210 | Symbol: GBPUSD | Dates: 2026-07-03 to 2026-07-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260708_GBPUSD_20260707_len5d_f48c1210' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-03' AND '2026-07-07';
