...
-- Run ID: p1_20260211_GBPUSD_20260210_len5d_2c08b0c8 | Symbol: GBPUSD | Dates: 2026-02-06 to 2026-02-10
-- =============================================================================
...
SELECT
    ...
    'p1_20260211_GBPUSD_20260210_len5d_2c08b0c8' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-06' AND '2026-02-10';
