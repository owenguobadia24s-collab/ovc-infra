...
-- Run ID: p1_20260408_GBPUSD_20260407_len5d_f66be959 | Symbol: GBPUSD | Dates: 2026-04-03 to 2026-04-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260408_GBPUSD_20260407_len5d_f66be959' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-03' AND '2026-04-07';
