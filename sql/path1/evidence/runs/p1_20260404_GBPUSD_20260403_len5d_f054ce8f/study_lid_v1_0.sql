...
-- Run ID: p1_20260404_GBPUSD_20260403_len5d_f054ce8f | Symbol: GBPUSD | Dates: 2026-03-30 to 2026-04-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260404_GBPUSD_20260403_len5d_f054ce8f' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-30' AND '2026-04-03';
