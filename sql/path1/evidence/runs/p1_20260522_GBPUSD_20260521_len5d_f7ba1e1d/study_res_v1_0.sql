...
-- Run ID: p1_20260522_GBPUSD_20260521_len5d_f7ba1e1d | Symbol: GBPUSD | Dates: 2026-05-17 to 2026-05-21
-- =============================================================================
...
SELECT
    ...
    'p1_20260522_GBPUSD_20260521_len5d_f7ba1e1d' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-17' AND '2026-05-21';
