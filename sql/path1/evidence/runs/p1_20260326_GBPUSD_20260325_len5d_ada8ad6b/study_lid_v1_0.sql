...
-- Run ID: p1_20260326_GBPUSD_20260325_len5d_ada8ad6b | Symbol: GBPUSD | Dates: 2026-03-21 to 2026-03-25
-- =============================================================================
...
SELECT
    ...
    'p1_20260326_GBPUSD_20260325_len5d_ada8ad6b' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-21' AND '2026-03-25';
