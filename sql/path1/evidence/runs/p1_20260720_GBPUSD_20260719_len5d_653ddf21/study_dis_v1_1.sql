...
-- Run ID: p1_20260720_GBPUSD_20260719_len5d_653ddf21 | Symbol: GBPUSD | Dates: 2026-07-15 to 2026-07-19
-- =============================================================================
...
SELECT
    ...
    'p1_20260720_GBPUSD_20260719_len5d_653ddf21' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-15' AND '2026-07-19';
