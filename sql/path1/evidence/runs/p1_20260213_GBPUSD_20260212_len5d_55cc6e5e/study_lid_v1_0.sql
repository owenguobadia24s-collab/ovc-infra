...
-- Run ID: p1_20260213_GBPUSD_20260212_len5d_55cc6e5e | Symbol: GBPUSD | Dates: 2026-02-08 to 2026-02-12
-- =============================================================================
...
SELECT
    ...
    'p1_20260213_GBPUSD_20260212_len5d_55cc6e5e' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-08' AND '2026-02-12';
