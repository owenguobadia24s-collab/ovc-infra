...
-- Run ID: p1_20260202_GBPUSD_20260201_len5d_31f19f8a | Symbol: GBPUSD | Dates: 2026-01-28 to 2026-02-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260202_GBPUSD_20260201_len5d_31f19f8a' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-01-28' AND '2026-02-01';
