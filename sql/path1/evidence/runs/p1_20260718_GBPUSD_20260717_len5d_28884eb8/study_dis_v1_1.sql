...
-- Run ID: p1_20260718_GBPUSD_20260717_len5d_28884eb8 | Symbol: GBPUSD | Dates: 2026-07-13 to 2026-07-17
-- =============================================================================
...
SELECT
    ...
    'p1_20260718_GBPUSD_20260717_len5d_28884eb8' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-13' AND '2026-07-17';
