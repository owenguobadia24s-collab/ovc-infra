...
-- Run ID: p1_20260515_GBPUSD_20260514_len5d_1fc87ccc | Symbol: GBPUSD | Dates: 2026-05-10 to 2026-05-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260515_GBPUSD_20260514_len5d_1fc87ccc' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-10' AND '2026-05-14';
