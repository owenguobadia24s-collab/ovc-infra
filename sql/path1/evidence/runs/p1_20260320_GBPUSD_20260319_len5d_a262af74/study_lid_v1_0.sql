...
-- Run ID: p1_20260320_GBPUSD_20260319_len5d_a262af74 | Symbol: GBPUSD | Dates: 2026-03-15 to 2026-03-19
-- =============================================================================
...
SELECT
    ...
    'p1_20260320_GBPUSD_20260319_len5d_a262af74' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-15' AND '2026-03-19';
