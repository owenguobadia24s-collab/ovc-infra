...
-- Run ID: p1_20260205_GBPUSD_20260204_len5d_34fb1bcb | Symbol: GBPUSD | Dates: 2026-01-31 to 2026-02-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260205_GBPUSD_20260204_len5d_34fb1bcb' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-01-31' AND '2026-02-04';
