...
-- Run ID: p1_20260423_GBPUSD_20260422_len5d_f1585a21 | Symbol: GBPUSD | Dates: 2026-04-18 to 2026-04-22
-- =============================================================================
...
SELECT
    ...
    'p1_20260423_GBPUSD_20260422_len5d_f1585a21' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-18' AND '2026-04-22';
