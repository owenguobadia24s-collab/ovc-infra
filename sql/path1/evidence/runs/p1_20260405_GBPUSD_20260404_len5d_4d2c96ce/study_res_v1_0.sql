...
-- Run ID: p1_20260405_GBPUSD_20260404_len5d_4d2c96ce | Symbol: GBPUSD | Dates: 2026-03-31 to 2026-04-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260405_GBPUSD_20260404_len5d_4d2c96ce' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-31' AND '2026-04-04';
