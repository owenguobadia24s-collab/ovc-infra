...
-- Run ID: p1_20260709_GBPUSD_20260708_len5d_3dd6d91e | Symbol: GBPUSD | Dates: 2026-07-04 to 2026-07-08
-- =============================================================================
...
SELECT
    ...
    'p1_20260709_GBPUSD_20260708_len5d_3dd6d91e' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-04' AND '2026-07-08';
