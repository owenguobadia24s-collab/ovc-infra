...
-- Run ID: p1_20260306_GBPUSD_20260305_len5d_718e737e | Symbol: GBPUSD | Dates: 2026-03-01 to 2026-03-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260306_GBPUSD_20260305_len5d_718e737e' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-01' AND '2026-03-05';
