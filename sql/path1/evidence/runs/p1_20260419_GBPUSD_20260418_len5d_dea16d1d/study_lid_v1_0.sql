...
-- Run ID: p1_20260419_GBPUSD_20260418_len5d_dea16d1d | Symbol: GBPUSD | Dates: 2026-04-14 to 2026-04-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260419_GBPUSD_20260418_len5d_dea16d1d' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-14' AND '2026-04-18';
