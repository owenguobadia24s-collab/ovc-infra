...
-- Run ID: p1_20260305_GBPUSD_20260304_len5d_7fbedce8 | Symbol: GBPUSD | Dates: 2026-02-28 to 2026-03-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260305_GBPUSD_20260304_len5d_7fbedce8' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-28' AND '2026-03-04';
