...
-- Run ID: p1_20260401_GBPUSD_20260331_len5d_2f5b1bc0 | Symbol: GBPUSD | Dates: 2026-03-27 to 2026-03-31
-- =============================================================================
...
SELECT
    ...
    'p1_20260401_GBPUSD_20260331_len5d_2f5b1bc0' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-27' AND '2026-03-31';
