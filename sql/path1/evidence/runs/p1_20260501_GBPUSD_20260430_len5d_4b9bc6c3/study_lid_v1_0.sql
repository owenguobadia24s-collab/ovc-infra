...
-- Run ID: p1_20260501_GBPUSD_20260430_len5d_4b9bc6c3 | Symbol: GBPUSD | Dates: 2026-04-26 to 2026-04-30
-- =============================================================================
...
SELECT
    ...
    'p1_20260501_GBPUSD_20260430_len5d_4b9bc6c3' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-26' AND '2026-04-30';
