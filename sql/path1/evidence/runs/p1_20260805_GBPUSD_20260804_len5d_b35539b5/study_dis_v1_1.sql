...
-- Run ID: p1_20260805_GBPUSD_20260804_len5d_b35539b5 | Symbol: GBPUSD | Dates: 2026-07-31 to 2026-08-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260805_GBPUSD_20260804_len5d_b35539b5' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-31' AND '2026-08-04';
