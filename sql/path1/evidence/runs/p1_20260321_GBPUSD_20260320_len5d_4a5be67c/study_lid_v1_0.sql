...
-- Run ID: p1_20260321_GBPUSD_20260320_len5d_4a5be67c | Symbol: GBPUSD | Dates: 2026-03-16 to 2026-03-20
-- =============================================================================
...
SELECT
    ...
    'p1_20260321_GBPUSD_20260320_len5d_4a5be67c' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-16' AND '2026-03-20';
