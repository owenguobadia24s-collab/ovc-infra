...
-- Run ID: p1_20260525_GBPUSD_20260524_len5d_a97fc698 | Symbol: GBPUSD | Dates: 2026-05-20 to 2026-05-24
-- =============================================================================
...
SELECT
    ...
    'p1_20260525_GBPUSD_20260524_len5d_a97fc698' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-20' AND '2026-05-24';
