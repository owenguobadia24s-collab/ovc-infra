...
-- Run ID: p1_20260315_GBPUSD_20260314_len5d_cb66c199 | Symbol: GBPUSD | Dates: 2026-03-10 to 2026-03-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260315_GBPUSD_20260314_len5d_cb66c199' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-10' AND '2026-03-14';
