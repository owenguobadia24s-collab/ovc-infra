...
-- Run ID: p1_20260630_GBPUSD_20260629_len5d_b68b7bb2 | Symbol: GBPUSD | Dates: 2026-06-25 to 2026-06-29
-- =============================================================================
...
SELECT
    ...
    'p1_20260630_GBPUSD_20260629_len5d_b68b7bb2' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-25' AND '2026-06-29';
