...
-- Run ID: p1_20260703_GBPUSD_20260702_len5d_3f45a5bb | Symbol: GBPUSD | Dates: 2026-06-28 to 2026-07-02
-- =============================================================================
...
SELECT
    ...
    'p1_20260703_GBPUSD_20260702_len5d_3f45a5bb' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-28' AND '2026-07-02';
