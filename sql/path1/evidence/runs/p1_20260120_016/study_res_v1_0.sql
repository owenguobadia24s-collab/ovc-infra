...
-- Run ID: p1_20260120_016 | Symbol: GBPUSD | Dates: 2023-09-11 to 2023-09-15
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-09-11' AND '2023-09-15';
