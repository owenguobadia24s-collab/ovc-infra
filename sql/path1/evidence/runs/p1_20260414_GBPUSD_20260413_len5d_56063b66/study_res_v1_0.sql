...
-- Run ID: p1_20260414_GBPUSD_20260413_len5d_56063b66 | Symbol: GBPUSD | Dates: 2026-04-09 to 2026-04-13
-- =============================================================================
...
SELECT
    ...
    'p1_20260414_GBPUSD_20260413_len5d_56063b66' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-09' AND '2026-04-13';
