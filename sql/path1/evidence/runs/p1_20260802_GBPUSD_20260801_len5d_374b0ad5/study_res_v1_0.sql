...
-- Run ID: p1_20260802_GBPUSD_20260801_len5d_374b0ad5 | Symbol: GBPUSD | Dates: 2026-07-28 to 2026-08-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260802_GBPUSD_20260801_len5d_374b0ad5' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-28' AND '2026-08-01';
