...
-- Run ID: p1_20260622_GBPUSD_20260621_len5d_55beaadd | Symbol: GBPUSD | Dates: 2026-06-17 to 2026-06-21
-- =============================================================================
...
SELECT
    ...
    'p1_20260622_GBPUSD_20260621_len5d_55beaadd' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-17' AND '2026-06-21';
