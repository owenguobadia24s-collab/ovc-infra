...
-- Run ID: p1_20260426_GBPUSD_20260425_len5d_fb5ac70b | Symbol: GBPUSD | Dates: 2026-04-21 to 2026-04-25
-- =============================================================================
...
SELECT
    ...
    'p1_20260426_GBPUSD_20260425_len5d_fb5ac70b' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-21' AND '2026-04-25';
