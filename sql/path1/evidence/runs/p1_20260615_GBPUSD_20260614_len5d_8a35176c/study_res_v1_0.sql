...
-- Run ID: p1_20260615_GBPUSD_20260614_len5d_8a35176c | Symbol: GBPUSD | Dates: 2026-06-10 to 2026-06-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260615_GBPUSD_20260614_len5d_8a35176c' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-10' AND '2026-06-14';
