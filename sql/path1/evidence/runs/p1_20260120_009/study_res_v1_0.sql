...
-- Run ID: p1_20260120_009 | Symbol: GBPUSD | Dates: 2023-10-30 to 2023-11-03
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-10-30' AND '2023-11-03';
