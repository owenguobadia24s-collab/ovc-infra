...
-- Run ID: p1_20260508_GBPUSD_20260507_len5d_f52884d9 | Symbol: GBPUSD | Dates: 2026-05-03 to 2026-05-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260508_GBPUSD_20260507_len5d_f52884d9' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-03' AND '2026-05-07';
