...
-- Run ID: p1_20260429_GBPUSD_20260428_len5d_1150d8b9 | Symbol: GBPUSD | Dates: 2026-04-24 to 2026-04-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260429_GBPUSD_20260428_len5d_1150d8b9' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-24' AND '2026-04-28';
