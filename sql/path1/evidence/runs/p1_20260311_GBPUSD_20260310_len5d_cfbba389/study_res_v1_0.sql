...
-- Run ID: p1_20260311_GBPUSD_20260310_len5d_cfbba389 | Symbol: GBPUSD | Dates: 2026-03-06 to 2026-03-10
-- =============================================================================
...
SELECT
    ...
    'p1_20260311_GBPUSD_20260310_len5d_cfbba389' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-06' AND '2026-03-10';
