...
-- Run ID: p1_20260505_GBPUSD_20260504_len5d_6e32b04f | Symbol: GBPUSD | Dates: 2026-04-30 to 2026-05-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260505_GBPUSD_20260504_len5d_6e32b04f' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-30' AND '2026-05-04';
