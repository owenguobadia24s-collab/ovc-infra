...
-- Run ID: p1_20260517_GBPUSD_20260516_len5d_997ced65 | Symbol: GBPUSD | Dates: 2026-05-12 to 2026-05-16
-- =============================================================================
...
SELECT
    ...
    'p1_20260517_GBPUSD_20260516_len5d_997ced65' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-12' AND '2026-05-16';
