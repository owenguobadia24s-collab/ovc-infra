...
-- Run ID: p1_20260222_GBPUSD_20260221_len5d_0cb670ca | Symbol: GBPUSD | Dates: 2026-02-17 to 2026-02-21
-- =============================================================================
...
SELECT
    ...
    'p1_20260222_GBPUSD_20260221_len5d_0cb670ca' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-17' AND '2026-02-21';
