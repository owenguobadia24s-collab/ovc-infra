...
-- Run ID: p1_20260120_007 | Symbol: GBPUSD | Dates: 2023-11-13 to 2023-11-17
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-11-13' AND '2023-11-17';
