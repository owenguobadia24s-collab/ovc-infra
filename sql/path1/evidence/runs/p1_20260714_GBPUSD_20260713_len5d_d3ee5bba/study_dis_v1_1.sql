...
-- Run ID: p1_20260714_GBPUSD_20260713_len5d_d3ee5bba | Symbol: GBPUSD | Dates: 2026-07-09 to 2026-07-13
-- =============================================================================
...
SELECT
    ...
    'p1_20260714_GBPUSD_20260713_len5d_d3ee5bba' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-09' AND '2026-07-13';
