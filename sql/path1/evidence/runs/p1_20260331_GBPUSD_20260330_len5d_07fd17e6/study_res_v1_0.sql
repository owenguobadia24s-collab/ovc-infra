...
-- Run ID: p1_20260331_GBPUSD_20260330_len5d_07fd17e6 | Symbol: GBPUSD | Dates: 2026-03-26 to 2026-03-30
-- =============================================================================
...
SELECT
    ...
    'p1_20260331_GBPUSD_20260330_len5d_07fd17e6' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-26' AND '2026-03-30';
