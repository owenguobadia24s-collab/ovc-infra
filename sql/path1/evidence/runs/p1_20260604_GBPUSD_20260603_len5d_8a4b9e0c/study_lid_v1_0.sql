...
-- Run ID: p1_20260604_GBPUSD_20260603_len5d_8a4b9e0c | Symbol: GBPUSD | Dates: 2026-05-30 to 2026-06-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260604_GBPUSD_20260603_len5d_8a4b9e0c' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-30' AND '2026-06-03';
