...
-- Run ID: p1_20260529_GBPUSD_20260528_len5d_ec999b84 | Symbol: GBPUSD | Dates: 2026-05-24 to 2026-05-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260529_GBPUSD_20260528_len5d_ec999b84' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-24' AND '2026-05-28';
