...
-- Run ID: p1_20260415_GBPUSD_20260414_len5d_e025c6a6 | Symbol: GBPUSD | Dates: 2026-04-10 to 2026-04-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260415_GBPUSD_20260414_len5d_e025c6a6' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-10' AND '2026-04-14';
