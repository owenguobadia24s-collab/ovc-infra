...
-- Run ID: p1_20260707_GBPUSD_20260706_len5d_1bda1206 | Symbol: GBPUSD | Dates: 2026-07-02 to 2026-07-06
-- =============================================================================
...
SELECT
    ...
    'p1_20260707_GBPUSD_20260706_len5d_1bda1206' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-02' AND '2026-07-06';
