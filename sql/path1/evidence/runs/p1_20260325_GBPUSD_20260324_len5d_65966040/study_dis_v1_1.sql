...
-- Run ID: p1_20260325_GBPUSD_20260324_len5d_65966040 | Symbol: GBPUSD | Dates: 2026-03-20 to 2026-03-24
-- =============================================================================
...
SELECT
    ...
    'p1_20260325_GBPUSD_20260324_len5d_65966040' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-20' AND '2026-03-24';
