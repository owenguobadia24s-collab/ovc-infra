...
-- Run ID: p1_20260218_GBPUSD_20260217_len5d_9a872ddf | Symbol: GBPUSD | Dates: 2026-02-13 to 2026-02-17
-- =============================================================================
...
SELECT
    ...
    'p1_20260218_GBPUSD_20260217_len5d_9a872ddf' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-13' AND '2026-02-17';
