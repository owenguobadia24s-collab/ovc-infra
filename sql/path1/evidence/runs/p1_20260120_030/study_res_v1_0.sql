...
-- Run ID: p1_20260120_030 | Symbol: GBPUSD | Dates: 2023-06-05 to 2023-06-09
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-06-05' AND '2023-06-09';
