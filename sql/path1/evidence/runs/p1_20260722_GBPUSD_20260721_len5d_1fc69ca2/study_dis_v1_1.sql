...
-- Run ID: p1_20260722_GBPUSD_20260721_len5d_1fc69ca2 | Symbol: GBPUSD | Dates: 2026-07-17 to 2026-07-21
-- =============================================================================
...
SELECT
    ...
    'p1_20260722_GBPUSD_20260721_len5d_1fc69ca2' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-17' AND '2026-07-21';
