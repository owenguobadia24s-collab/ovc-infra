...
-- Run ID: p1_20260514_GBPUSD_20260513_len5d_d4921ac0 | Symbol: GBPUSD | Dates: 2026-05-09 to 2026-05-13
-- =============================================================================
...
SELECT
    ...
    'p1_20260514_GBPUSD_20260513_len5d_d4921ac0' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-09' AND '2026-05-13';
