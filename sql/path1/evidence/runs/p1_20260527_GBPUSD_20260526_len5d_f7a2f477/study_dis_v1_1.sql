...
-- Run ID: p1_20260527_GBPUSD_20260526_len5d_f7a2f477 | Symbol: GBPUSD | Dates: 2026-05-22 to 2026-05-26
-- =============================================================================
...
SELECT
    ...
    'p1_20260527_GBPUSD_20260526_len5d_f7a2f477' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-22' AND '2026-05-26';
