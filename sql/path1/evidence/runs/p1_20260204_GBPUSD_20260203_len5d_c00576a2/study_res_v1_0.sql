...
-- Run ID: p1_20260204_GBPUSD_20260203_len5d_c00576a2 | Symbol: GBPUSD | Dates: 2026-01-30 to 2026-02-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260204_GBPUSD_20260203_len5d_c00576a2' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-01-30' AND '2026-02-03';
