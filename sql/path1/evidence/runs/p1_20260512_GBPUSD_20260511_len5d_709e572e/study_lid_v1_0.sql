...
-- Run ID: p1_20260512_GBPUSD_20260511_len5d_709e572e | Symbol: GBPUSD | Dates: 2026-05-07 to 2026-05-11
-- =============================================================================
...
SELECT
    ...
    'p1_20260512_GBPUSD_20260511_len5d_709e572e' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-07' AND '2026-05-11';
