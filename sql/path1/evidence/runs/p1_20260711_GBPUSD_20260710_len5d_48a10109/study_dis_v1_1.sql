...
-- Run ID: p1_20260711_GBPUSD_20260710_len5d_48a10109 | Symbol: GBPUSD | Dates: 2026-07-06 to 2026-07-10
-- =============================================================================
...
SELECT
    ...
    'p1_20260711_GBPUSD_20260710_len5d_48a10109' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-06' AND '2026-07-10';
