...
-- Run ID: p1_20260516_GBPUSD_20260515_len5d_917fe82d | Symbol: GBPUSD | Dates: 2026-05-11 to 2026-05-15
-- =============================================================================
...
SELECT
    ...
    'p1_20260516_GBPUSD_20260515_len5d_917fe82d' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-11' AND '2026-05-15';
