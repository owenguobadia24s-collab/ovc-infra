...
-- Run ID: p1_20260120_020 | Symbol: GBPUSD | Dates: 2023-08-14 to 2023-08-18
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-08-14' AND '2023-08-18';
