...
-- Run ID: p1_20260314_GBPUSD_20260313_len5d_28954fe1 | Symbol: GBPUSD | Dates: 2026-03-09 to 2026-03-13
-- =============================================================================
...
SELECT
    ...
    'p1_20260314_GBPUSD_20260313_len5d_28954fe1' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-09' AND '2026-03-13';
