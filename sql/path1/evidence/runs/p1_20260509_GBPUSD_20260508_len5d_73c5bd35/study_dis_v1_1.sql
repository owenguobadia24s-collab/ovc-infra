...
-- Run ID: p1_20260509_GBPUSD_20260508_len5d_73c5bd35 | Symbol: GBPUSD | Dates: 2026-05-04 to 2026-05-08
-- =============================================================================
...
SELECT
    ...
    'p1_20260509_GBPUSD_20260508_len5d_73c5bd35' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-04' AND '2026-05-08';
