...
-- Run ID: p1_20260402_GBPUSD_20260401_len5d_a328b6d2 | Symbol: GBPUSD | Dates: 2026-03-28 to 2026-04-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260402_GBPUSD_20260401_len5d_a328b6d2' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-28' AND '2026-04-01';
