...
-- Run ID: p1_20260120_031 | Symbol: GBPUSD | Dates: 2022-12-12 to 2022-12-14
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2022-12-12' AND '2022-12-14';
