...
-- Run ID: p1_20260208_GBPUSD_20260207_len5d_3d531e1b | Symbol: GBPUSD | Dates: 2026-02-03 to 2026-02-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260208_GBPUSD_20260207_len5d_3d531e1b' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-03' AND '2026-02-07';
