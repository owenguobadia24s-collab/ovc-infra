...
-- Run ID: p1_20260607_GBPUSD_20260606_len5d_73893270 | Symbol: GBPUSD | Dates: 2026-06-02 to 2026-06-06
-- =============================================================================
...
SELECT
    ...
    'p1_20260607_GBPUSD_20260606_len5d_73893270' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-02' AND '2026-06-06';
