...
-- Run ID: p1_20260715_GBPUSD_20260714_len5d_7ec97562 | Symbol: GBPUSD | Dates: 2026-07-10 to 2026-07-14
-- =============================================================================
...
SELECT
    ...
    'p1_20260715_GBPUSD_20260714_len5d_7ec97562' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-10' AND '2026-07-14';
