...
-- Run ID: p1_20260120_017 | Symbol: GBPUSD | Dates: 2023-09-04 to 2023-09-08
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-09-04' AND '2023-09-08';
