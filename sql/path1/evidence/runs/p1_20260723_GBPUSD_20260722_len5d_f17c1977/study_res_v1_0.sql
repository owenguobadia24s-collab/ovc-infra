...
-- Run ID: p1_20260723_GBPUSD_20260722_len5d_f17c1977 | Symbol: GBPUSD | Dates: 2026-07-18 to 2026-07-22
-- =============================================================================
...
SELECT
    ...
    'p1_20260723_GBPUSD_20260722_len5d_f17c1977' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-18' AND '2026-07-22';
