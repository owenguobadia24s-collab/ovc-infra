...
-- Run ID: p1_20260519_GBPUSD_20260518_len5d_56521ba6 | Symbol: GBPUSD | Dates: 2026-05-14 to 2026-05-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260519_GBPUSD_20260518_len5d_56521ba6' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-14' AND '2026-05-18';
