...
-- Run ID: p1_20260308_GBPUSD_20260307_len5d_03c0ae3e | Symbol: GBPUSD | Dates: 2026-03-03 to 2026-03-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260308_GBPUSD_20260307_len5d_03c0ae3e' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-03' AND '2026-03-07';
