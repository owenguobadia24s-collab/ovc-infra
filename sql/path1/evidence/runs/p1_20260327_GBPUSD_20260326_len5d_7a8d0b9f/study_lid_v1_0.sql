...
-- Run ID: p1_20260327_GBPUSD_20260326_len5d_7a8d0b9f | Symbol: GBPUSD | Dates: 2026-03-22 to 2026-03-26
-- =============================================================================
...
SELECT
    ...
    'p1_20260327_GBPUSD_20260326_len5d_7a8d0b9f' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-22' AND '2026-03-26';
