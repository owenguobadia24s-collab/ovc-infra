...
-- Run ID: p1_20260316_GBPUSD_20260315_len5d_5e0353bf | Symbol: GBPUSD | Dates: 2026-03-11 to 2026-03-15
-- =============================================================================
...
SELECT
    ...
    'p1_20260316_GBPUSD_20260315_len5d_5e0353bf' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-11' AND '2026-03-15';
