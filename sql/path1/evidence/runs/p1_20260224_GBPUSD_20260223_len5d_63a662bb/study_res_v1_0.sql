...
-- Run ID: p1_20260224_GBPUSD_20260223_len5d_63a662bb | Symbol: GBPUSD | Dates: 2026-02-19 to 2026-02-23
-- =============================================================================
...
SELECT
    ...
    'p1_20260224_GBPUSD_20260223_len5d_63a662bb' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-19' AND '2026-02-23';
