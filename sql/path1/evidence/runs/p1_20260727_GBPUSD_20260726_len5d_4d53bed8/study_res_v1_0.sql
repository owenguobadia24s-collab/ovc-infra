...
-- Run ID: p1_20260727_GBPUSD_20260726_len5d_4d53bed8 | Symbol: GBPUSD | Dates: 2026-07-22 to 2026-07-26
-- =============================================================================
...
SELECT
    ...
    'p1_20260727_GBPUSD_20260726_len5d_4d53bed8' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-22' AND '2026-07-26';
