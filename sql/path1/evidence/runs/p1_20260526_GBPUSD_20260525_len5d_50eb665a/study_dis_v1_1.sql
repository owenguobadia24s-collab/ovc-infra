...
-- Run ID: p1_20260526_GBPUSD_20260525_len5d_50eb665a | Symbol: GBPUSD | Dates: 2026-05-21 to 2026-05-25
-- =============================================================================
...
SELECT
    ...
    'p1_20260526_GBPUSD_20260525_len5d_50eb665a' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-21' AND '2026-05-25';
