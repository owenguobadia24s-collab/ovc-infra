...
-- Run ID: p1_20260216_GBPUSD_20260215_len5d_8e865471 | Symbol: GBPUSD | Dates: 2026-02-11 to 2026-02-15
-- =============================================================================
...
SELECT
    ...
    'p1_20260216_GBPUSD_20260215_len5d_8e865471' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-11' AND '2026-02-15';
