...
-- Run ID: p1_20260724_GBPUSD_20260723_len5d_3dd15eb5 | Symbol: GBPUSD | Dates: 2026-07-19 to 2026-07-23
-- =============================================================================
...
SELECT
    ...
    'p1_20260724_GBPUSD_20260723_len5d_3dd15eb5' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-19' AND '2026-07-23';
