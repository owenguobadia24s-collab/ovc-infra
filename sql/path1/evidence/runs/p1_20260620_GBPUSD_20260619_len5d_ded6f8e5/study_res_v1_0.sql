...
-- Run ID: p1_20260620_GBPUSD_20260619_len5d_ded6f8e5 | Symbol: GBPUSD | Dates: 2026-06-15 to 2026-06-19
-- =============================================================================
...
SELECT
    ...
    'p1_20260620_GBPUSD_20260619_len5d_ded6f8e5' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-15' AND '2026-06-19';
