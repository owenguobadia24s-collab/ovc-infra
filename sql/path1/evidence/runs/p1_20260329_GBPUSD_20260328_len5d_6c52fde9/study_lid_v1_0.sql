...
-- Run ID: p1_20260329_GBPUSD_20260328_len5d_6c52fde9 | Symbol: GBPUSD | Dates: 2026-03-24 to 2026-03-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260329_GBPUSD_20260328_len5d_6c52fde9' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-24' AND '2026-03-28';
