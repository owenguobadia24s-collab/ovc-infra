...
-- Run ID: p1_20260214_GBPUSD_20260213_len5d_e5c7de9d | Symbol: GBPUSD | Dates: 2026-02-09 to 2026-02-13
-- =============================================================================
...
SELECT
    ...
    'p1_20260214_GBPUSD_20260213_len5d_e5c7de9d' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-09' AND '2026-02-13';
