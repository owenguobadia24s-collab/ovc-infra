...
-- Run ID: p1_20260410_GBPUSD_20260409_len5d_798bac57 | Symbol: GBPUSD | Dates: 2026-04-05 to 2026-04-09
-- =============================================================================
...
SELECT
    ...
    'p1_20260410_GBPUSD_20260409_len5d_798bac57' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-05' AND '2026-04-09';
