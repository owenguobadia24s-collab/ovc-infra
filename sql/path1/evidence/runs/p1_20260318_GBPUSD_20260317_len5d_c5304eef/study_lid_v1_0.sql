...
-- Run ID: p1_20260318_GBPUSD_20260317_len5d_c5304eef | Symbol: GBPUSD | Dates: 2026-03-13 to 2026-03-17
-- =============================================================================
...
SELECT
    ...
    'p1_20260318_GBPUSD_20260317_len5d_c5304eef' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-13' AND '2026-03-17';
