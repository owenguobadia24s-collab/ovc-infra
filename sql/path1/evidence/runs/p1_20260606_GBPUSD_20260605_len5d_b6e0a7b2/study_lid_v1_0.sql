...
-- Run ID: p1_20260606_GBPUSD_20260605_len5d_b6e0a7b2 | Symbol: GBPUSD | Dates: 2026-06-01 to 2026-06-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260606_GBPUSD_20260605_len5d_b6e0a7b2' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-01' AND '2026-06-05';
