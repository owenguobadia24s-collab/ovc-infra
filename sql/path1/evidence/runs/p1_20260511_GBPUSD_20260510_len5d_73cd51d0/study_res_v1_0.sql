...
-- Run ID: p1_20260511_GBPUSD_20260510_len5d_73cd51d0 | Symbol: GBPUSD | Dates: 2026-05-06 to 2026-05-10
-- =============================================================================
...
SELECT
    ...
    'p1_20260511_GBPUSD_20260510_len5d_73cd51d0' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-06' AND '2026-05-10';
