...
-- Run ID: p1_20260728_GBPUSD_20260727_len5d_3fa1a5cb | Symbol: GBPUSD | Dates: 2026-07-23 to 2026-07-27
-- =============================================================================
...
SELECT
    ...
    'p1_20260728_GBPUSD_20260727_len5d_3fa1a5cb' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-23' AND '2026-07-27';
