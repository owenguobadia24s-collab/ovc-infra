...
-- Run ID: p1_20260617_GBPUSD_20260616_len5d_8cf43821 | Symbol: GBPUSD | Dates: 2026-06-12 to 2026-06-16
-- =============================================================================
...
SELECT
    ...
    'p1_20260617_GBPUSD_20260616_len5d_8cf43821' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-12' AND '2026-06-16';
