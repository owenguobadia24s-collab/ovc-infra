...
-- Run ID: p1_20260530_GBPUSD_20260529_len5d_86b17fb6 | Symbol: GBPUSD | Dates: 2026-05-25 to 2026-05-29
-- =============================================================================
...
SELECT
    ...
    'p1_20260530_GBPUSD_20260529_len5d_86b17fb6' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-25' AND '2026-05-29';
