...
-- Run ID: p1_20260324_GBPUSD_20260323_len5d_8624f296 | Symbol: GBPUSD | Dates: 2026-03-19 to 2026-03-23
-- =============================================================================
...
SELECT
    ...
    'p1_20260324_GBPUSD_20260323_len5d_8624f296' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-19' AND '2026-03-23';
