...
-- Run ID: p1_20260521_GBPUSD_20260520_len5d_ed7d57e7 | Symbol: GBPUSD | Dates: 2026-05-16 to 2026-05-20
-- =============================================================================
...
SELECT
    ...
    'p1_20260521_GBPUSD_20260520_len5d_ed7d57e7' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-16' AND '2026-05-20';
