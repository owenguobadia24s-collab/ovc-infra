...
-- Run ID: p1_20260705_GBPUSD_20260704_len5d_e0512e20 | Symbol: GBPUSD | Dates: 2026-06-30 to 2026-07-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260705_GBPUSD_20260704_len5d_e0512e20' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-30' AND '2026-07-04';
