...
-- Run ID: p1_20260319_GBPUSD_20260318_len5d_ec67e0cb | Symbol: GBPUSD | Dates: 2026-03-14 to 2026-03-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260319_GBPUSD_20260318_len5d_ec67e0cb' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-14' AND '2026-03-18';
