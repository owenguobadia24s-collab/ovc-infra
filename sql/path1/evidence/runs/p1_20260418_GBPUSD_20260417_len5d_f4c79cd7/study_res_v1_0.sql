...
-- Run ID: p1_20260418_GBPUSD_20260417_len5d_f4c79cd7 | Symbol: GBPUSD | Dates: 2026-04-13 to 2026-04-17
-- =============================================================================
...
SELECT
    ...
    'p1_20260418_GBPUSD_20260417_len5d_f4c79cd7' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-13' AND '2026-04-17';
