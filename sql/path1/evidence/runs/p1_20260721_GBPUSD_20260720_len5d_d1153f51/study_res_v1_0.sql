...
-- Run ID: p1_20260721_GBPUSD_20260720_len5d_d1153f51 | Symbol: GBPUSD | Dates: 2026-07-16 to 2026-07-20
-- =============================================================================
...
SELECT
    ...
    'p1_20260721_GBPUSD_20260720_len5d_d1153f51' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-16' AND '2026-07-20';
