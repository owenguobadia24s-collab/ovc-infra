...
-- Run ID: p1_20260608_GBPUSD_20260607_len5d_ba3be838 | Symbol: GBPUSD | Dates: 2026-06-03 to 2026-06-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260608_GBPUSD_20260607_len5d_ba3be838' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-03' AND '2026-06-07';
