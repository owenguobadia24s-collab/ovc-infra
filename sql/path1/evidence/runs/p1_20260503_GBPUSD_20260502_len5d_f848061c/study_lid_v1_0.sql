...
-- Run ID: p1_20260503_GBPUSD_20260502_len5d_f848061c | Symbol: GBPUSD | Dates: 2026-04-28 to 2026-05-02
-- =============================================================================
...
SELECT
    ...
    'p1_20260503_GBPUSD_20260502_len5d_f848061c' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-28' AND '2026-05-02';
