...
-- Run ID: p1_20260430_GBPUSD_20260429_len5d_b3b6e77c | Symbol: GBPUSD | Dates: 2026-04-25 to 2026-04-29
-- =============================================================================
...
SELECT
    ...
    'p1_20260430_GBPUSD_20260429_len5d_b3b6e77c' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-25' AND '2026-04-29';
