...
-- Run ID: p1_20260725_GBPUSD_20260724_len5d_59bbe9c6 | Symbol: GBPUSD | Dates: 2026-07-20 to 2026-07-24
-- =============================================================================
...
SELECT
    ...
    'p1_20260725_GBPUSD_20260724_len5d_59bbe9c6' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-20' AND '2026-07-24';
