...
-- Run ID: p1_20260131_GBPUSD_20260130_len5d_687bafa3 | Symbol: GBPUSD | Dates: 2026-01-26 to 2026-01-30
-- =============================================================================
...
SELECT
    ...
    'p1_20260131_GBPUSD_20260130_len5d_687bafa3' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-01-26' AND '2026-01-30';
