...
-- Run ID: p1_20260506_GBPUSD_20260505_len5d_a9914826 | Symbol: GBPUSD | Dates: 2026-05-01 to 2026-05-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260506_GBPUSD_20260505_len5d_a9914826' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-01' AND '2026-05-05';
