...
-- Run ID: p1_20260623_GBPUSD_20260622_len5d_a25e0b63 | Symbol: GBPUSD | Dates: 2026-06-18 to 2026-06-22
-- =============================================================================
...
SELECT
    ...
    'p1_20260623_GBPUSD_20260622_len5d_a25e0b63' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-18' AND '2026-06-22';
