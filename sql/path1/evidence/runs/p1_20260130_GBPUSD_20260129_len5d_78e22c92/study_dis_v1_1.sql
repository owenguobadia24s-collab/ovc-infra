...
-- Run ID: p1_20260130_GBPUSD_20260129_len5d_78e22c92 | Symbol: GBPUSD | Dates: 2026-01-25 to 2026-01-29
-- =============================================================================
...
SELECT
    ...
    'p1_20260130_GBPUSD_20260129_len5d_78e22c92' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-01-25' AND '2026-01-29';
