...
-- Run ID: p1_20260621_GBPUSD_20260620_len5d_25f6c827 | Symbol: GBPUSD | Dates: 2026-06-16 to 2026-06-20
-- =============================================================================
...
SELECT
    ...
    'p1_20260621_GBPUSD_20260620_len5d_25f6c827' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-16' AND '2026-06-20';
