...
-- Run ID: p1_20260518_GBPUSD_20260517_len5d_b13c6a1c | Symbol: GBPUSD | Dates: 2026-05-13 to 2026-05-17
-- =============================================================================
...
SELECT
    ...
    'p1_20260518_GBPUSD_20260517_len5d_b13c6a1c' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-13' AND '2026-05-17';
