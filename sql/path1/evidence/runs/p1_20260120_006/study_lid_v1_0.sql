...
-- Run ID: p1_20260120_006 | Symbol: GBPUSD | Dates: 2023-11-20 to 2023-11-24
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-11-20' AND '2023-11-24';
