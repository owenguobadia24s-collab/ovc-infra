...
-- Run ID: p1_20260416_GBPUSD_20260415_len5d_03768ae6 | Symbol: GBPUSD | Dates: 2026-04-11 to 2026-04-15
-- =============================================================================
...
SELECT
    ...
    'p1_20260416_GBPUSD_20260415_len5d_03768ae6' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-11' AND '2026-04-15';
