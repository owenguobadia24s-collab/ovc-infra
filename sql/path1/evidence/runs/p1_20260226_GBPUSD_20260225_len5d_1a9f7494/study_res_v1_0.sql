...
-- Run ID: p1_20260226_GBPUSD_20260225_len5d_1a9f7494 | Symbol: GBPUSD | Dates: 2026-02-21 to 2026-02-25
-- =============================================================================
...
SELECT
    ...
    'p1_20260226_GBPUSD_20260225_len5d_1a9f7494' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-21' AND '2026-02-25';
