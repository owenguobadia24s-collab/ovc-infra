...
-- Run ID: p1_20260303_GBPUSD_20260302_len5d_cd2abc9a | Symbol: GBPUSD | Dates: 2026-02-26 to 2026-03-02
-- =============================================================================
...
SELECT
    ...
    'p1_20260303_GBPUSD_20260302_len5d_cd2abc9a' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-26' AND '2026-03-02';
