...
-- Run ID: p1_20260603_GBPUSD_20260602_len5d_f358ae80 | Symbol: GBPUSD | Dates: 2026-05-29 to 2026-06-02
-- =============================================================================
...
SELECT
    ...
    'p1_20260603_GBPUSD_20260602_len5d_f358ae80' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-29' AND '2026-06-02';
