...
-- Run ID: p1_20260209_GBPUSD_20260208_len5d_b4cdab60 | Symbol: GBPUSD | Dates: 2026-02-04 to 2026-02-08
-- =============================================================================
...
SELECT
    ...
    'p1_20260209_GBPUSD_20260208_len5d_b4cdab60' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-04' AND '2026-02-08';
