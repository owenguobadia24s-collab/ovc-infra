...
-- Run ID: p1_20260413_GBPUSD_20260412_len5d_c17436a8 | Symbol: GBPUSD | Dates: 2026-04-08 to 2026-04-12
-- =============================================================================
...
SELECT
    ...
    'p1_20260413_GBPUSD_20260412_len5d_c17436a8' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-08' AND '2026-04-12';
