...
-- Run ID: p1_20260219_GBPUSD_20260218_len5d_b231613d | Symbol: GBPUSD | Dates: 2026-02-14 to 2026-02-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260219_GBPUSD_20260218_len5d_b231613d' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-14' AND '2026-02-18';
