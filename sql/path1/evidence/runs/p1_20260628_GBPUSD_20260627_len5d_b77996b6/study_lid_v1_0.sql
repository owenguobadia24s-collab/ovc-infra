...
-- Run ID: p1_20260628_GBPUSD_20260627_len5d_b77996b6 | Symbol: GBPUSD | Dates: 2026-06-23 to 2026-06-27
-- =============================================================================
...
SELECT
    ...
    'p1_20260628_GBPUSD_20260627_len5d_b77996b6' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-23' AND '2026-06-27';
