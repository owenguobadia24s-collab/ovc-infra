...
-- Run ID: p1_20260504_GBPUSD_20260503_len5d_4193744b | Symbol: GBPUSD | Dates: 2026-04-29 to 2026-05-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260504_GBPUSD_20260503_len5d_4193744b' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-29' AND '2026-05-03';
