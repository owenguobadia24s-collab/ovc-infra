...
-- Run ID: p1_20260120_014 | Symbol: GBPUSD | Dates: 2023-09-25 to 2023-09-29
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-09-25' AND '2023-09-29';
