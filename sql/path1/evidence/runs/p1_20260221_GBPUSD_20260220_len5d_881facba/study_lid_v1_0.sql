...
-- Run ID: p1_20260221_GBPUSD_20260220_len5d_881facba | Symbol: GBPUSD | Dates: 2026-02-16 to 2026-02-20
-- =============================================================================
...
SELECT
    ...
    'p1_20260221_GBPUSD_20260220_len5d_881facba' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-16' AND '2026-02-20';
