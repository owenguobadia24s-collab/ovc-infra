...
-- Run ID: p1_20260801_GBPUSD_20260731_len5d_31171ec8 | Symbol: GBPUSD | Dates: 2026-07-27 to 2026-07-31
-- =============================================================================
...
SELECT
    ...
    'p1_20260801_GBPUSD_20260731_len5d_31171ec8' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-27' AND '2026-07-31';
