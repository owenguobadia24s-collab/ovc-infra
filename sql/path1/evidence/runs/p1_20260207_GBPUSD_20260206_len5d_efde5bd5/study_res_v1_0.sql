...
-- Run ID: p1_20260207_GBPUSD_20260206_len5d_efde5bd5 | Symbol: GBPUSD | Dates: 2026-02-02 to 2026-02-06
-- =============================================================================
...
SELECT
    ...
    'p1_20260207_GBPUSD_20260206_len5d_efde5bd5' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-02' AND '2026-02-06';
