...
-- Run ID: p1_20260726_GBPUSD_20260725_len5d_5f399c0d | Symbol: GBPUSD | Dates: 2026-07-21 to 2026-07-25
-- =============================================================================
...
SELECT
    ...
    'p1_20260726_GBPUSD_20260725_len5d_5f399c0d' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-21' AND '2026-07-25';
