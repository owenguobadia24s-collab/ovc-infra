...
-- Run ID: p1_20260605_GBPUSD_20260604_len5d_53fba032 | Symbol: GBPUSD | Dates: 2026-05-31 to 2026-06-04
-- =============================================================================
...
SELECT
    ...
    'p1_20260605_GBPUSD_20260604_len5d_53fba032' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-31' AND '2026-06-04';
