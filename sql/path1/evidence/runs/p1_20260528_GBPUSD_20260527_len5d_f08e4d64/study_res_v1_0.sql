...
-- Run ID: p1_20260528_GBPUSD_20260527_len5d_f08e4d64 | Symbol: GBPUSD | Dates: 2026-05-23 to 2026-05-27
-- =============================================================================
...
SELECT
    ...
    'p1_20260528_GBPUSD_20260527_len5d_f08e4d64' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-23' AND '2026-05-27';
