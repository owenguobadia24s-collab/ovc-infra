...
-- Run ID: p1_20260719_GBPUSD_20260718_len5d_20c55b79 | Symbol: GBPUSD | Dates: 2026-07-14 to 2026-07-18
-- =============================================================================
...
SELECT
    ...
    'p1_20260719_GBPUSD_20260718_len5d_20c55b79' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-14' AND '2026-07-18';
