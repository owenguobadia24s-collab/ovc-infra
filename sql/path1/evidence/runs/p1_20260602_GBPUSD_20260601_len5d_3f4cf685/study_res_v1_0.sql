...
-- Run ID: p1_20260602_GBPUSD_20260601_len5d_3f4cf685 | Symbol: GBPUSD | Dates: 2026-05-28 to 2026-06-01
-- =============================================================================
...
SELECT
    ...
    'p1_20260602_GBPUSD_20260601_len5d_3f4cf685' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-05-28' AND '2026-06-01';
