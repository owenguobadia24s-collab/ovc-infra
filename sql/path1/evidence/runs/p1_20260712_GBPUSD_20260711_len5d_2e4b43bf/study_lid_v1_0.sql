...
-- Run ID: p1_20260712_GBPUSD_20260711_len5d_2e4b43bf | Symbol: GBPUSD | Dates: 2026-07-07 to 2026-07-11
-- =============================================================================
...
SELECT
    ...
    'p1_20260712_GBPUSD_20260711_len5d_2e4b43bf' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-07' AND '2026-07-11';
