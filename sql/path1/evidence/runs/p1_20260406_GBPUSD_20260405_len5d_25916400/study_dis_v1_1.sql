...
-- Run ID: p1_20260406_GBPUSD_20260405_len5d_25916400 | Symbol: GBPUSD | Dates: 2026-04-01 to 2026-04-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260406_GBPUSD_20260405_len5d_25916400' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-01' AND '2026-04-05';
