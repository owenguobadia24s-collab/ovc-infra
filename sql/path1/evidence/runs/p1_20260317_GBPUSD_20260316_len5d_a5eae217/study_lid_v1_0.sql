...
-- Run ID: p1_20260317_GBPUSD_20260316_len5d_a5eae217 | Symbol: GBPUSD | Dates: 2026-03-12 to 2026-03-16
-- =============================================================================
...
SELECT
    ...
    'p1_20260317_GBPUSD_20260316_len5d_a5eae217' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-12' AND '2026-03-16';
