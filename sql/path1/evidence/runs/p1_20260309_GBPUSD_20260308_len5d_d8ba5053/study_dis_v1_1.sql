...
-- Run ID: p1_20260309_GBPUSD_20260308_len5d_d8ba5053 | Symbol: GBPUSD | Dates: 2026-03-04 to 2026-03-08
-- =============================================================================
...
SELECT
    ...
    'p1_20260309_GBPUSD_20260308_len5d_d8ba5053' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-04' AND '2026-03-08';
