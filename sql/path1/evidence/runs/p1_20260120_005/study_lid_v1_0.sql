...
-- Run ID: p1_20260120_005 | Symbol: GBPUSD | Dates: 2023-11-27 to 2023-12-01
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-11-27' AND '2023-12-01';
