...
-- Run ID: p1_20260611_GBPUSD_20260610_len5d_9de4264e | Symbol: GBPUSD | Dates: 2026-06-06 to 2026-06-10
-- =============================================================================
...
SELECT
    ...
    'p1_20260611_GBPUSD_20260610_len5d_9de4264e' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-06' AND '2026-06-10';
