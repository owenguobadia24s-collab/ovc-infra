...
-- Run ID: p1_20260424_GBPUSD_20260423_len5d_d353d1c4 | Symbol: GBPUSD | Dates: 2026-04-19 to 2026-04-23
-- =============================================================================
...
SELECT
    ...
    'p1_20260424_GBPUSD_20260423_len5d_d353d1c4' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-19' AND '2026-04-23';
