...
-- Run ID: p1_20260330_GBPUSD_20260329_len5d_b4336e60 | Symbol: GBPUSD | Dates: 2026-03-25 to 2026-03-29
-- =============================================================================
...
SELECT
    ...
    'p1_20260330_GBPUSD_20260329_len5d_b4336e60' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-03-25' AND '2026-03-29';
