...
-- Run ID: p1_20260120_021 | Symbol: GBPUSD | Dates: 2023-08-07 to 2023-08-11
-- =============================================================================
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-08-07' AND '2023-08-11';
