...
-- Run ID: p1_20260120_011 | Symbol: GBPUSD | Dates: 2023-10-16 to 2023-10-20
-- =============================================================================
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2023-10-16' AND '2023-10-20';
