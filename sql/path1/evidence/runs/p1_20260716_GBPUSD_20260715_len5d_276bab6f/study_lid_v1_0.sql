...
-- Run ID: p1_20260716_GBPUSD_20260715_len5d_276bab6f | Symbol: GBPUSD | Dates: 2026-07-11 to 2026-07-15
-- =============================================================================
...
SELECT
    ...
    'p1_20260716_GBPUSD_20260715_len5d_276bab6f' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-11' AND '2026-07-15';
