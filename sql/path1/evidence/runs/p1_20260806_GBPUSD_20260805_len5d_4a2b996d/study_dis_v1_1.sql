...
-- Run ID: p1_20260806_GBPUSD_20260805_len5d_4a2b996d | Symbol: GBPUSD | Dates: 2026-08-01 to 2026-08-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260806_GBPUSD_20260805_len5d_4a2b996d' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-08-01' AND '2026-08-05';
