...
-- Run ID: p1_20260227_GBPUSD_20260226_len5d_99f3f6bf | Symbol: GBPUSD | Dates: 2026-02-22 to 2026-02-26
-- =============================================================================
...
SELECT
    ...
    'p1_20260227_GBPUSD_20260226_len5d_99f3f6bf' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-22' AND '2026-02-26';
