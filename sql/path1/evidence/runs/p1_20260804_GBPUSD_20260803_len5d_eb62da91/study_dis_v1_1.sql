...
-- Run ID: p1_20260804_GBPUSD_20260803_len5d_eb62da91 | Symbol: GBPUSD | Dates: 2026-07-30 to 2026-08-03
-- =============================================================================
...
SELECT
    ...
    'p1_20260804_GBPUSD_20260803_len5d_eb62da91' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-30' AND '2026-08-03';
