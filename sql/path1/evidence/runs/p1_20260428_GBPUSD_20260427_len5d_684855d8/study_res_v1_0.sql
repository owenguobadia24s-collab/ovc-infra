...
-- Run ID: p1_20260428_GBPUSD_20260427_len5d_684855d8 | Symbol: GBPUSD | Dates: 2026-04-23 to 2026-04-27
-- =============================================================================
...
SELECT
    ...
    'p1_20260428_GBPUSD_20260427_len5d_684855d8' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-23' AND '2026-04-27';
