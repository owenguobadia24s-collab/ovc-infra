...
-- Run ID: p1_20260613_GBPUSD_20260612_len5d_b4ae8b94 | Symbol: GBPUSD | Dates: 2026-06-08 to 2026-06-12
-- =============================================================================
...
SELECT
    ...
    'p1_20260613_GBPUSD_20260612_len5d_b4ae8b94' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-08' AND '2026-06-12';
