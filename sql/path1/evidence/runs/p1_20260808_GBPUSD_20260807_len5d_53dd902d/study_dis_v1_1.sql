...
-- Run ID: p1_20260808_GBPUSD_20260807_len5d_53dd902d | Symbol: GBPUSD | Dates: 2026-08-03 to 2026-08-07
-- =============================================================================
...
SELECT
    ...
    'p1_20260808_GBPUSD_20260807_len5d_53dd902d' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-08-03' AND '2026-08-07';
