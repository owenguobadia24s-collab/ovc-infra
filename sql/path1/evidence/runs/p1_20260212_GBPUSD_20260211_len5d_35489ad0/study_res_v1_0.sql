...
-- Run ID: p1_20260212_GBPUSD_20260211_len5d_35489ad0 | Symbol: GBPUSD | Dates: 2026-02-07 to 2026-02-11
-- =============================================================================
...
SELECT
    ...
    'p1_20260212_GBPUSD_20260211_len5d_35489ad0' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-07' AND '2026-02-11';
