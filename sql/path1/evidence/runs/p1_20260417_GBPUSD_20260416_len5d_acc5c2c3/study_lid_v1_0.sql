...
-- Run ID: p1_20260417_GBPUSD_20260416_len5d_acc5c2c3 | Symbol: GBPUSD | Dates: 2026-04-12 to 2026-04-16
-- =============================================================================
...
SELECT
    ...
    'p1_20260417_GBPUSD_20260416_len5d_acc5c2c3' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-04-12' AND '2026-04-16';
