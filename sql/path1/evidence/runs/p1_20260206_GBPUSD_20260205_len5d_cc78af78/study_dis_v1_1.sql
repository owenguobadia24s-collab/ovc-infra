...
-- Run ID: p1_20260206_GBPUSD_20260205_len5d_cc78af78 | Symbol: GBPUSD | Dates: 2026-02-01 to 2026-02-05
-- =============================================================================
...
SELECT
    ...
    'p1_20260206_GBPUSD_20260205_len5d_cc78af78' AS run_id,
...
WHERE dis_v1_1_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-02-01' AND '2026-02-05';
