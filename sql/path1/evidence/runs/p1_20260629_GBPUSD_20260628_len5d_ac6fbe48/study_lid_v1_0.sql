...
-- Run ID: p1_20260629_GBPUSD_20260628_len5d_ac6fbe48 | Symbol: GBPUSD | Dates: 2026-06-24 to 2026-06-28
-- =============================================================================
...
SELECT
    ...
    'p1_20260629_GBPUSD_20260628_len5d_ac6fbe48' AS run_id,
...
WHERE lid_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-06-24' AND '2026-06-28';
