...
-- Run ID: p1_20260717_GBPUSD_20260716_len5d_8838057d | Symbol: GBPUSD | Dates: 2026-07-12 to 2026-07-16
-- =============================================================================
...
SELECT
    ...
    'p1_20260717_GBPUSD_20260716_len5d_8838057d' AS run_id,
...
WHERE res_v1_0_raw IS NOT NULL
  AND sym = 'GBPUSD'
  AND to_timestamp(bar_close_ms/1000)::date BETWEEN '2026-07-12' AND '2026-07-16';
