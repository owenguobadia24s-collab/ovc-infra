-- =============================================================================
-- STUDY: LID vs Outcomes (Bucketed, Descriptive)
-- =============================================================================
-- Score: LID-v1.0 — Liquidity Interaction Density
-- Status: NON-CANONICAL (Path 1 Research)
-- Created: 2026-01-20
--
-- Purpose: Descriptive association between LID z-score buckets and outcomes
--
...
-- -----------------------------------------------------------------------------
-- CTE: score_data
-- Compute LID score with z-score normalization
-- -----------------------------------------------------------------------------
score_data AS (
    SELECT
        c1.block_id,
