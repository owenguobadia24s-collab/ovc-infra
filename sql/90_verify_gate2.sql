-- 1) Tables exist
select to_regclass('ovc.ovc_blocks_v01_1_min') as min_table;
...
-- 4) Enum sanity
select bias_dir, count(*) from ovc.ovc_blocks_v01_1_min group by bias_dir;
select pred_dir, count(*) from ovc.ovc_blocks_v01_1_min group by pred_dir;