...
| 2b-split-C1 | Python `src/derived/compute_c1_v0_1.py` + SQL view `sql/derived/v_ovc_c1_features_v0_1.sql` | Table `derived.ovc_c1_features_v0_1` |
| 2b-split-C2 | Python `src/derived/compute_c2_v0_1.py` + SQL view `sql/derived/v_ovc_c2_features_v0_1.sql` | Table `derived.ovc_c2_features_v0_1` |
| 2b-split-C3 | Python `src/derived/compute_c3_regime_trend_v0_1.py` (UNUSED) + SQL view `sql/derived/v_ovc_c3_features_v0_1.sql` | Table `derived.ovc_c3_regime_trend_v0_1` (if materialized) |

**Workflows**: `backfill_then_validate.yml` (invokes C1, C2 compute only; C3 compute unused)
...
| 3b-alternate | SQL view `sql/derived/v_ovc_c_outcomes_v0_1.sql` | View `derived.v_ovc_c_outcomes_v0_1` (reads from C1/C2/C3 views, NOT canonical table) |
...
| F2 | **Multiple sources of truth (B)**: Legacy `derived.ovc_block_features_v0_1` AND split C1/C2/C3 tables/views coexist | Structural |
| F3 | **Unused C3 compute path**: `compute_c3_regime_trend_v0_1.py` exists but no workflow invokes it | Operational |
...
- `derived.ovc_c1_features_v0_1`, `derived.ovc_c2_features_v0_1` (Python-computed)
- Option B SQL views (`v_ovc_c1_features_v0_1.sql`, `v_ovc_c2_features_v0_1.sql`, `v_ovc_c3_features_v0_1.sql`)
...
- C3 regime classification (compute script unused)
...
4. C3 compute script is not invoked by any workflow
