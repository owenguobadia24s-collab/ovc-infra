...
class TestComputeC1Inline:
    ...
    def test_logret_with_zero_close(self):
        ...
        result = compute_c1_inline(o=1.0, h=1.5, l=0.0, c=0.0)
        assert result["logret"] is None
    ...
    def test_determinism(self):
        ...
        results = [compute_c1_inline(o, h, l, c) for _ in range(10)]
...
class TestValidationResult:
    ...
    def test_default_values(self):
        ...
        assert result.c1_row_count == 0
        assert result.c2_row_count == 0
        assert result.coverage_parity is True
        assert result.c1_duplicates == 0
        assert result.c2_duplicates == 0
...
class TestColumnLists:
    ...
    def test_c1_columns(self):
        """C1 columns should match compute_c1 output."""
    ...
    def test_c2_columns(self):
        """C2 columns should include all documented features."""
...
class TestEdgeCases:
    ...
    def test_zero_price_bar(self):
        ...
        result = compute_c1_inline(o=0, h=0, l=0, c=0)
    ...
    def test_negative_prices(self):
        ...
        result = compute_c1_inline(o=-1.0, h=0.0, l=-2.0, c=-0.5)
    ...
    def test_very_small_range(self):
        ...
        result = compute_c1_inline(o=1.0, h=1.0001, l=0.9999, c=1.00005)
